# -*- coding: utf-8 -*-
"""
Created on Thu Oct 21 20:54:39 2021
...
def random_flip(image,
                flip_axes_probs = (0.5, 0.5, 0.5), # zyx
                ):
    # Flip transform
...
def random_rotation(image,
                    random_angles = (30*np.pi/180, 30*np.pi/180, 30*np.pi/180), # zyx (in radians)
                    ):
    # Rotation transform
